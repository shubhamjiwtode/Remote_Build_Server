...
namespace MessagePassingComm
{
  ...
  public class Receiver : IMessagePassingComm
  {
    ...
    public void close()
    {
      ...
      commHost.Close();
        ...
        public bool openFileForWrite(string name,string child)
        {
            //Console.Write("+++++++++++++++++++++++++++++++++++++++++++++++++++");
            try
            {
              //  Console.WriteLine(ServiceEnvironment.fileStorage);
                //Console.Write("+++++++++++++++++++++++++++++++++++++++++++++++++++");
                string path = ServiceEnvironment.fileStorage +"/"+ child; //+ "/childProc" + child;
  ...
  public class Sender
  {
    ...
    public bool postFile(string fileName,string child)
    {
      ...
      {
                //Console.WriteLine("..........................");
                //Console.WriteLine(ClientEnvironment.fileStorage);
                //Console.WriteLine(fileName);
                string path = Path.Combine(ClientEnvironment.fileStorage, fileName);
                string xxxx = System.IO.Path.GetFullPath(path);
                Console.WriteLine(xxxx);
                fs = File.OpenRead(path);
                //Console.WriteLine("............++++++++++++++++++++++..............");
                bytesRemaining = fs.Length;
                
                channel.openFileForWrite(fileName,child);
  ...
  class TestPCommService
  {
    ...
    public static bool testComm()
    {
      ...
      foreach (string name in names)
      {
        ...
        bool transferSuccess = comm.postFile(name,"8081");
